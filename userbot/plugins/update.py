...
BOT_IS_UP_TO_DATE = "**The Kakashi-UserBot †** is up-to-date sir⚜️."
...
async def updater(message):
    ...
    if message.text[8:] != "now":
        ...
        await message.respond(f"Do | `.update now` | to update Kakashi UB⚡️")
        return
    temp_upstream_remote.fetch(active_branch_name)
