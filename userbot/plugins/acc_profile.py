...
@borg.on(lightning_cmd(pattern="pbio (.*)"))  # pylint:disable=E0602
async def _(event):
    if event.fwd_from:
        return
    ...
    try:
        ...
        await event.edit("Cʜᴀɴɢᴇᴅ ʏᴏᴜʀ ʙɪᴏ sᴜᴄᴇᴇsғᴜʟʟʏ ᴍʏ ᴍᴀsᴛᴇʀ")
    except Exception as e:  # pylint:disable=C0103,W0703
        await event.edit(str(e))


@borg.on(lightning_cmd(pattern="pname ((.|\n)*)"))  # pylint:disable=E0602,W0703
async def _(event):
    if event.fwd_from:
        return
    ...
    try:
        ...
        await event.edit("Sᴜᴄᴄᴇssғᴜʟʟʏ ᴄʜᴀɴɢᴇᴅ ʏᴏᴜʀ ɴᴀᴍᴇ..")
    except Exception as e:  # pylint:disable=C0103,W0703
        await event.edit(str(e))


@borg.on(lightning_cmd(pattern="ppic"))  # pylint:disable=E0602
async def _(event):
    if event.fwd_from:
        return
    ...
    try:
        ...
        if photo:
            ...
            try:
                ...
                await event.edit("Sᴜᴄᴄᴇᴅ ɪɴ ᴄʜᴀɴɢɪɴɢ ʏᴏᴜʀ ᴘʀᴏғɪʟᴇ ᴘɪᴄ.😉")
    try:
        os.remove(photo)
    except Exception as e:  # pylint:disable=C0103,W0703
