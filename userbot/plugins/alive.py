...
if ALIVE_PIC is None:
    PM_iMG = "https://telegra.ph/file/8e158f3cccac5ee2eeece.jpg"
else:
    PM_iMG = ALIVE_PIC
...
if CAT_IMGE is None:
    CAT_IMG = "https://telegra.ph/file/8e158f3cccac5ee2eeece.jpg"
else:
    CAT_IMG = CAT_IMGE
...
async def amireallyalive(salive):
    ...
    if ALIVE_PHOTTO:
        pm_caption = "**Kᴀᴋᴀsʜɪ UsᴇʀBᴏᴛ ɪs ᴏɴʟɪɴᴇ**\n"
        pm_caption =          "Bᴏᴛ Iɴғᴏ\n"
        pm_caption += f"Mʏ ᴘᴇᴇʀᴏᴏ ᴍᴀsᴛᴇʀ »» {DEFAULTUSER}\n"
        pm_caption += "Tᴇʟᴇᴛʜᴏɴ Vᴇʀsɪᴏɴ  »» 1.17.5\n"
        pm_caption += "Pʏᴛʜᴏɴ Vᴇʀsɪᴏɴ    »» 3.9.0\n"
        pm_caption += "Bᴏᴛ Vᴇʀsɪᴏɴ       »» `Uᴘ ᴛᴏ ᴅᴀᴛᴇ😉`\n"
        pm_caption += "Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ     »» [Kᴀᴋᴀsʜɪ Sᴜᴘᴘᴏʀᴛ](https://t.me/kakashi_support)\n"
        pm_caption += "✨Rᴇᴘᴏ✨              »» [Kᴀᴋᴀsʜɪ Uʙ](https://github.com/ProBoy-X/Kakashi-UserBot)
        ...
        return
    req = requests.get("https://telegra.ph/file/8e158f3cccac5ee2eeece.jpg")
    ...
    with BytesIO() as sticker:
        ...
        await borg.send_message(
            ...
            "Tᴇʟᴇᴛʜᴏɴ        »» 1.17.5\n"
            "Pʏᴛʜᴏɴ          »» 3.9.0\n"
            "Sᴜᴘᴘᴏʀᴛ Cʜᴀɴɴᴇʟ »» [Kᴀᴋᴀsʜɪ Uʙ](https://t.me/Kakashi_Support_Official)\n"
            "Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ   »» [Kᴀᴋᴀsʜɪ Uʙ](https://t.me/kakashi_Support)\n"
            "Lɪᴄᴇɴᴄᴇ         »» [PʀᴏBᴏʏ-X](https://github.com/ProBoy-X)\n"
            "Cᴏᴘʏʀɪɢʜᴛ Bʏ    »» [PʀᴏBᴏʏ-X](https://github.com/ProBoy-X)",
            link_preview=False,
        )
        await salive.delete()
...
pm_caption = "__**🔥🔥ӄǟӄǟֆɦɨ ʊֆɛʀɮօȶ ɨֆ օռʟɨռɛ🔥🔥**__\n\n"
...
pm_caption += f"😈ӄǟӄǟֆɦɨ ʊֆɛʀɮօȶ😈       : __**{hellversion}**__\n"

pm_caption += f"⚜️Sudo⚜️            : `{sudou}`\n"

pm_caption += "⚠️CHANNEL⚠️   : [ᴊᴏɪɴ](https://t.me/kakashi_support_official)\n"

pm_caption += "🔥CREATOR🔥    : [Nub Here](https://t.me/Its_JassManak)\n\n"

pm_caption += "    [✨REPO✨](https://github.com/ProBoy-X/Kakashi-UserBot) 🔹 [📜License📜](https://github.com/ProBoy-X/Kakashi-UserBot/blob/master/LICENSE)"
