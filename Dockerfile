...
#Import Gudz
RUN wget https://raw.githubusercontent.com/ProBoy-X/Kakashi-UserBot/master/lightningrun.py
RUN wget https://raw.githubusercontent.com/ProBoy-X/Kakashi-UserBot/master/requirements.txt
#Start Fumkin
RUN pip3 install -r requirements.txt

CMD ["python3","KakashiUserBot.py"]
